...
using Aura.Infrastructure.Services.Notifications;
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Notification microservice for AURA"
    });
...
if (app.Environment.IsDevelopment() || app.Environment.IsProduction())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "AURA Notification Service v1");
